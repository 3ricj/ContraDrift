...
namespace NINA.Contradrift.ContradriftTestCategory {
    ...
    public class ContradriftTrigger : SequenceTrigger {
        /// <summary>
        ...
        public ContradriftTrigger() {
        }

        public override object Clone() {
            return new ContradriftTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(ContradriftTrigger)}";
        }
    }
}