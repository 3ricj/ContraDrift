...
namespace NINA.Contradrift.ContradriftTestCategory {
    ...
    public class ContradriftCondition : SequenceCondition {
        /// <summary>
        ...
        public override object Clone() {
            return new ContradriftCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(ContradriftCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}