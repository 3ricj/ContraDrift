...
namespace NINA.Contradrift.ContradriftTestCategory {
    /// <summary>
    ...
    [ExportMetadata("Category", "ContraDrift")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class ContradriftInstruction : SequenceItem {
        /// <summary>
        ...
        public ContradriftInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public ContradriftInstruction(ContradriftInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new ContradriftInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(ContradriftInstruction)}, Text: {Text}";
        }
    }
}