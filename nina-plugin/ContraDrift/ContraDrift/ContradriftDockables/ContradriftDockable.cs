...
namespace NINA.Contradrift.ContradriftDockables {
    /// <summary>
    ...
    public class ContradriftDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public ContradriftDockable(
            ...
            dict.Source = new Uri("NINA.Contradrift;component/ContradriftDockables/ContradriftDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["NINA.Contradrift_AltitudeSVG"];
